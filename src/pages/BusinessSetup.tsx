...
import { Building2, CheckCircle, Globe, ArrowRight, Phone, Users, Landmark, Briefcase, Minus, FileText } from 'lucide-react';
...
const BusinessSetup = () => {
  ...
  const processSteps = [
    { step: 1, title: 'Initial Consultation', description: 'Free consultation to understand your business needs and recommend the best setup option.', icon: Phone },
    { step: 2, title: 'Documentation', description: 'Prepare and verify all required documents for your chosen business setup type.', icon: FileText },
    { step: 3, title: 'Authority Approval', description: 'Submit applications to relevant authorities and track approval status.', icon: CheckCircle },
    { step: 4, title: 'License Issuance', description: 'Receive your trade license and complete business setup formalities.', icon: Briefcase }
  ];
  ...
  const faqs = [
    { q: "Do I need a local sponsor for a Mainland company?", a: "Not anymore for most business activities. The UAE now allows 100% foreign ownership for over 1,000 commercial and industrial activities on the Mainland." },
    { q: "Can a Free Zone company do business in the Mainland?", a: "A Free Zone company cannot directly trade or provide services in the Mainland. However, they can work through a local distributor or by opening a branch of the Free Zone company in the Mainland." },
    { q: "What is the main purpose of an Offshore company?", a: "The primary purposes are to conduct international business, act as a holding company for assets and investments, and provide a high degree of privacy and asset protection." }
  ];
      ...
      <section className="relative pt-40 pb-20 bg-gradient-hero text-white text-center">
        ...
        <div className="relative container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6">Dubai Business Setup Made Simple</h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-8">Launch your venture in the heart of global commerce. We provide end-to-end solutions for Mainland, Free Zone, and Offshore company formation.</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <AnimatePresence mode="wait">
            {selectedSetup && (
              <motion.div key={selectedSetup.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }} className="bg-card p-6 md:p-8 rounded-2xl border">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
                  <div>
                    <h3 className="text-2xl md:text-3xl font-heading font-bold mb-4">{selectedSetup.name}</h3>
                  ...
                  <div className="bg-muted/50 p-6 rounded-lg">
                    <h3 className="text-xl md:text-2xl font-heading font-bold mb-6">Our 4-Step Process</h3>
                    <div className="space-y-6">
