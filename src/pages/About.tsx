...
const About = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description: "Recognized as Dubai's premier business services provider with 500+ satisfied clients."
    }
  ];
  ...
  const team = [
    {
      ...
      experience: "30+ Years",
      expertise: "Business Setup, Strategic Planning"
    },
    {
      name: "Sarah Ahmed",
      position: "PRO Services Head",
      experience: "15+ Years",
      expertise: "Government Relations, Visa Processing"
    },
    {
      name: "Omar Hassan",
          ...
          <div className="max-w-4xl mx-auto">
            {timeline.map((item, index) => (
              ...
              >
                ...
                <div className="w-8 h-8 bg-primary rounded-full border-4 border-background shadow-lg z-10"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {team.map((member, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="bg-card p-8 rounded-xl border text-center hover:shadow-lg transition-all duration-300 hover-3d"
              >
