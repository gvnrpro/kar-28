    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-white/90 mb-8 max-w-4xl mx-auto leading-relaxed animate-slide-in-right">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <Button
              ...
              size="lg"
              className="bg-gradient-gold hover:bg-gradient-gold/90 text-primary-foreground text-lg px-12 py-6 rounded-xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 group animate-bounce-in-scale gold-glow"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-white/50 text-white hover:bg-white hover:text-primary text-lg px-12 py-6 rounded-xl font-semibold transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          {trustIndicators.map((indicator, index) => (
            <div
              key={index}
              className="text-center p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-110 group"
              style={{ animationDelay: `${index * 0.2}s` }}
            >
              <indicator.icon className="h-12 w-12 text-secondary mx-auto mb-4 group-hover:animate-bounce" />
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 max-w-4xl mx-auto mb-16">
