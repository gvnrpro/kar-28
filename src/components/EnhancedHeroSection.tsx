        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-12 sm:mb-16 px-4">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-2 border-white/50 text-base hover:bg-white hover:text-primary text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 rounded-xl font-semibold transition-all duration-300 hover:scale-105 backdrop-blur-sm min-h-[56px] touch-manipulation"
            >
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 max-w-4xl mx-auto mb-12 sm:mb-16 mx-4">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-white/90 italic text-base sm:text-lg lg:text-xl leading-relaxed">
              "KAR Business Services is the best & helped our Dubai expansion. Professional, efficient, and results-driven!"
            </p>
            <p className="text-white/70 mt-3 sm:mt-4 font-semibold text-sm sm:text-base">
              - Jassim Mohd, HR Director, Manpower Company, Dubai
            </p>
          </div>
        </div>
      </div>
